...
var semigroupRow = new Prelude.Semigroup(function (v) {
    return function (v1) {
        ...
        if (v instanceof Para && v1 instanceof Para) {
            return new Para(Prelude["<>"](Prelude.semigroupArray)(v.value0)(v1.value0));
        };
    ...
    var go = function (ind) {
        return function (v) {
            ...
            if (v instanceof Para) {
                return Data_String.joinWith("\n")(Prelude["<$>"](Prelude.functorArray)(go(ind))(v.value0));
            };
            if (v instanceof Indent) {
                return go(ind + f(v.value0))(v.value1);
            };
            throw new Error("Failed pattern match at Psa.Printer line 72, column 1 - line 77, column 1: " + [ ind.constructor.name, v.constructor.name ]);
        };
    };
    return go("");
};
var renderAnsi = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Psa.Printer line 78, column 1 - line 79, column 1: " + [ v.constructor.name, v1.constructor.name ]);
    };
};
var render = function (ansi) {
    return renderRow(function ($41) {
        return Data_String.joinWith("")(Prelude.map(Prelude.functorArray)(renderAnsi(ansi))($41));
    });
};
var plain = Plain.create;
var renderErrorRange = function (start) {
    return function (len) {
        return [ plain(Psa_Util.replicate(Data_Monoid.monoidString)(start - 1)(" ")), style(Ansi_Output.foreground(Ansi_Codes.Red.value))(Psa_Util.replicate(Data_Monoid.monoidString)(len)("^")) ];
    };
};
var renderErrorTick = function (start) {
    return function ($$char) {
        return [ plain(Psa_Util.replicate(Data_Monoid.monoidString)(start - 1)(" ")), style(Ansi_Output.foreground(Ansi_Codes.Red.value))($$char) ];
    };
};
    ...
    return function (sep) {
        return function (num) {
            return function (code) {
                return [ style(Ansi_Output.dim)(Psa_Util.padLeft(gutter)(Prelude.show(Prelude.showInt)(num)) + sep), plain(code) ];
            };
        };
    };
};
    ...
    return function (pos) {
        return function (lines) {
            return para((function () {
                if (lines.length === 1) {
                    return [ line(lines[0]), line(renderErrorRange(pos.startColumn + offset | 0)(pos.endColumn - pos.startColumn)) ];
                };
                return [ line(renderErrorTick(pos.startColumn + offset | 0)("v")), para(Prelude["<$>"](Prelude.functorArray)(line)(lines)), line(renderErrorTick((pos.endColumn + offset | 0) - 1)("^")) ];
            })());
        };
    };
};
var renderSource = function (pos) {
    return function (lines) {
        ...
        var gutter = Data_String.length(Prelude.show(Prelude.showInt)(pos.endLine));
        var source = Prelude["<$>"](Prelude.functorArray)(Data_Tuple.uncurry(sourceLine(gutter)("  ")))(Data_Array.zip(lineNums)(lines));
        var source$prime = (function () {
            var $36 = Data_Array.length(source) > 7;
            if ($36) {
                return Prelude["<>"](Prelude.semigroupArray)(Data_Array.take(3)(source))(Prelude["<>"](Prelude.semigroupArray)([ [ plain(Psa_Util.replicate(Data_Monoid.monoidString)(gutter + 2 | 0)(" ")), style(Ansi_Output.dim)("...") ] ])(Data_Array.drop(Data_Array.length(source) - 3)(source)));
            };
            if (!$36) {
                return source;
            };
            throw new Error("Failed pattern match at Psa.Printer line 91, column 5 - line 97, column 1: " + [ $36.constructor.name ]);
        })();
...
var ansiLength = function (v) {
    ...
    throw new Error("Failed pattern match at Psa.Printer line 65, column 1 - line 66, column 1: " + [ v.constructor.name ]);
};
module.exports = {
